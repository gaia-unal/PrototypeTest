...
export const DyslexiaSuperficialHome = () => {
  ...
  const detectionTests = [
    {
      ...
      description: 'Consta de un conjunto de actividades interactivas que pretenden evaluar las competencias para este tipo de dislexia, así como se describe en las Tablas 3 y 4. El test se conforma de 7 actividades para cada competencia, es decir, el test tiene un total de 14 actividades',
  ...
  const attentionResources = [
    ...
    },
    {
      ...
      description: 'Consta de un conjunto de 7 actividades como las descritas en la Tabla 4; a diferencia del test de detección, en este caso hay retroalimentación constante de si las respuestas están correctas o incorrectas. También se incluye un conjunto de recomendaciones al docente de qué habilidades y categorías se deben potenciar en el estudiante en caso de tener que reforzar esta competencia. NOTA: Para esta actividad necesitamos: Plastilina, arena, una hoja de cuaderno y un lápiz.',
