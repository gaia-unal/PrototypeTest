  ...
  return (
    <>
      ...
      <div className='container w-75 app-description'>
        <h4 className='text-center'>Pruebas de detección temprana y recursos de atención para estudiantes con dificultades específicas de aprendizaje</h4>
      </div>
      ...
      <h1 className='text-center title'>Módulos</h1>
