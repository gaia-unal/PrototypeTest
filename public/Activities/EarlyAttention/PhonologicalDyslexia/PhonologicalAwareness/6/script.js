...
// have been selected.
var opcionesCorrectasEnOrden = ["opcion2", "opcion4", "opcion1", "opcion3"];
...
document.addEventListener("DOMContentLoaded", () => {
	...
	const changeFontSize = (initialFontSize, initialWidth) => {
		...
		number1.style.fontSize = initialFontSize + 'rem';
		number2.style.fontSize = initialFontSize + 'rem';
		number3.style.fontSize = initialFontSize + 'rem';
		number4.style.fontSize = initialFontSize + 'rem';
